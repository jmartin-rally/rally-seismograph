...
Ext.define('CustomApp', {
    ...
    launch: function() {
        ...
        this.subscribe( this.key_prefix, function( opt ) { that._getTeamMembers(); } );
    ...
    _showChart: function(data) {
        ...
        this.chart = Ext.create('Rally.ui.chart.Chart', {
            ...
            chartConfig: {
                ...
                series: data,
                xAxis: { type: 'datetime' },
                yAxis: { minRange: 5, min: 1, tickInterval: 1, max: 5 }
            }
        });
